...
const FALLBACK_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  driver_car_wrong_class: {
    ru: 'Класс заказа не совпадает с классом вашего автомобиля. Выберите на клиенте такой же класс, как у подтверждённой машины водителя, или поменяйте класс автомобиля в профиле.',
    en: "The order class does not match your car class. Choose the same class as the driver's approved car, or change the car class in the profile.",
    fr: 'La classe de commande ne correspond pas a la classe de votre voiture. Choisissez la meme classe que la voiture approuvee du chauffeur ou modifiez la classe dans le profil.',
    ar: 'فئة الطلب لا تطابق فئة سيارة السائق. اختر نفس فئة السيارة المعتمدة للسائق أو غيّر فئة السيارة في الملف الشخصي.',
  },
  client_offer_title: {
    ru: 'Заказ по предложению',
    en: 'Offer-based order',
    fr: 'Commande par offre',
    ar: 'طلب قائم على العروض',
  },
  client_offer_desired_price_label: {
    ru: 'Желаемая цена клиента',
    en: 'Customer desired price',
    fr: 'Prix souhaite par le client',
    ar: 'السعر المطلوب من العميل',
  },
  client_offer_not_fixed_price: {
    ru: 'Цена не фиксированная: водитель отправит свою сумму, ETA, свободные места и комментарий.',
    en: 'The price is not fixed: the driver will send their price, ETA, free seats and comment.',
    fr: 'Le prix n est pas fixe : le chauffeur enverra son prix, son ETA, les places libres et un commentaire.',
    ar: 'السعر غير ثابت: سيرسل السائق السعر ووقت الوصول والمقاعد المتاحة والتعليق.',
  },
  client_offer_class_hint: {
    ru: 'Класс можно менять. Если у водителя подтверждён Petit, создайте заказ Petit, иначе backend отклонит отклик водителя.',
    en: 'You can change the class. If the driver is approved as Petit, create a Petit order, otherwise the backend will reject the driver offer.',
    fr: 'Vous pouvez changer la classe. Si le chauffeur est approuve en Petit, creez une commande Petit, sinon le backend refusera l offre.',
    ar: 'يمكنك تغيير الفئة. إذا كان السائق معتمداً كـ Petit فأنشئ طلب Petit، وإلا سيرفض الخادم عرض السائق.',
  },
  ...
  driver_offer_form_title: {
    ru: 'Ваше предложение клиенту',
    en: 'Your offer to the customer',
    fr: 'Votre offre au client',
    ar: 'عرضك للعميل',
  },
  driver_offer_price: {
    ru: 'Моя цена',
  ...
  driver_offer_comment: {
    ru: 'Комментарий водителя',
    en: 'Driver comment',
    fr: 'Commentaire du chauffeur',
    ar: 'تعليق السائق',
  },
  driver_offer_sent: {
  ...
  driver_offer_sent_status: {
    ru: 'Предложение отправлено. Ожидайте выбора клиента.',
    en: 'Offer sent. Wait for the customer to choose.',
    fr: 'Offre envoyee. Attendez le choix du client.',
    ar: 'تم إرسال العرض. انتظر اختيار العميل.',
  },
  driver_offer_accepted: {
    ru: 'Клиент выбрал ваше предложение. Заказ назначен вам.',
    en: 'The customer chose your offer. The order is assigned to you.',
    fr: 'Le client a choisi votre offre. La commande vous est attribuee.',
    ar: 'اختار العميل عرضك. تم تعيين الطلب لك.',
  },
  driver_offer_rejected: {
    ru: 'Клиент выбрал другого водителя.',
    en: 'The customer chose another driver.',
    fr: 'Le client a choisi un autre chauffeur.',
    ar: 'اختار العميل سائقا آخر.',
  },
  driver_offer_expired: {
    ru: 'Срок предложения истёк. Можно отправить новое предложение, если заказ еще активен.',
    en: 'The offer has expired. You can send a new offer if the order is still active.',
    fr: 'L offre a expire. Vous pouvez envoyer une nouvelle offre si la commande est encore active.',
    ar: 'انتهت صلاحية العرض. يمكنك إرسال عرض جديد إذا كان الطلب لا يزال نشطا.',
  },
  ...
  driver_offer_status: {
    ...
    en: 'Offer status',
    fr: 'Statut de l offre',
    ar: 'حالة العرض',
  },
  driver_offer_offers_count: {
    ru: 'Предложений отправлено',
    en: 'Offers sent',
    fr: 'Offres envoyees',
    ar: 'العروض المرسلة',
  },
  ...
  driver_offer_no_fake_competition: {
    ru: 'Цены других водителей не показываются.',
    en: 'Prices from other drivers are not shown.',
    fr: 'Les prix des autres chauffeurs ne sont pas affiches.',
    ar: 'لا يتم عرض أسعار السائقين الآخرين.',
  },
  ...
  client_offer_order_mode: {
    ru: 'Межгород / предложение',
    en: 'Intercity / offer',
    fr: 'Interurbain / offre',
    ar: 'بين المدن / عرض',
  },
  ...
  client_offer_hint: {
    ru: 'Водители отправят свои условия. Заказ закрепится только после выбора исполнителя.',
    en: 'Drivers will send their terms. The order is assigned only after you choose a driver.',
    fr: 'Les chauffeurs enverront leurs conditions. La commande ne sera attribuee qu apres votre choix.',
    ar: 'سيرسل السائقون شروطهم. يتم تعيين الطلب فقط بعد اختيار السائق.',
  },
  client_offer_settings_open: {
    ru: 'Настроить предложение',
    en: 'Set offer details',
    fr: 'Configurer l offre',
    ar: 'إعداد تفاصيل العرض',
  },
