...
export interface IOptions {
  ...
  b_order_mode?: string
  mode?: string
  offer_mode?: string | boolean
  driver_offer_mode?: string | boolean
  driver_offer?: IDriverOffer | boolean
  my_offer?: IDriverOffer
  offer?: IDriverOffer
  offer_event?: string
  driver_offer_event?: string
...
export interface IOrder
  ...
  b_id: string
  /** Режим заказа: например OFFER для договорных междугородних поездок */
  order_mode?: string
  b_order_mode?: string
  b_mode?: string
  mode?: string
  ...
  b_voting?: boolean
  /** Создать заказ как предложение/отклик без немедленного назначения */
  b_only_offer?: number | boolean
  /** Личное предложение текущего водителя по OFFER-заказу */
  driver_offer?: IDriverOffer
  my_offer?: IDriverOffer
  offer?: IDriverOffer
  /** Событие OFFER-заказа: offer_accepted / offer_rejected / offer_expired */
  offer_event?: string
  driver_offer_event?: string
  /** Количество отправленных предложений по заказу */
  offers_count?: number
  offer_count?: number
  driver_offers_count?: number
