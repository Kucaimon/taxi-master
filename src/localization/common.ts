export default {
  ...
  PICKUP_TIP_ACTIVE_LABEL: 'pickup_tip_active_label',
  PICKUP_TIP_CONFIRM_BODY: 'pickup_tip_confirm_body',
  PICKUP_TIP_CONFIRM_NEW_TOTAL: 'pickup_tip_confirm_new_total',
  PICKUP_TIP_CONFIRM_TITLE: 'pickup_tip_confirm_title',
  PINNED: 'pinned',
